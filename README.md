...
- `xmllint` and `xmlto`
- [Prince](https://www.princexml.com/) _(optional for PDF generation, latest version is 13.5 at the time of this writing)_
...
sudo dnf install path/to/prince-13.5-1.centos8.x86_64.rpm # (optional for PDF generation)
```
