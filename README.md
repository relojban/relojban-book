...
- `xmllint` and `xmlto`
- [Prince](https://www.princexml.com/) _(optional for PDF generation, latest version is 14.1 at the time of this writing)_
...
sudo dnf install path/to/prince-14.1-1.centos8.x86_64.rpm # (optional for PDF generation)
```
