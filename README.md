...
- `xmllint` and `xmlto`
- [Prince](https://www.princexml.com/) _(optional for PDF generation, latest version is 12.4 at the time of this writing)_
...
sudo dnf install path/to/prince-12.4-1.centos7.x86_64.rpm # (optional for PDF generation)
```
